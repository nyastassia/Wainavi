...
winery1.grape_variety_ids = [1, 2, 3, 4, 5]
winery1.wine_style_ids = [5, 6, 4, 1]
winery1.award_ids = []
winery1.experience_ids = []
winery1.dining_ids = []

winery2 = Winery.create!(
  title: "OSA WINERY（オサワイナリー）",
...
winery2.grape_variety_ids = [6, 8, 10, 11, 21, 13, 14, 16, 17, 18, 19, 27, 28]
winery2.wine_style_ids = [1, 2, 4]
winery2.award_ids = []
winery2.experience_ids = []
winery2.dining_ids = []

winery3 = Winery.create!(
  title: "丸藤葡萄酒工業(株)",
...
winery3.grape_variety_ids = [7, 8, 20, 22, 23, 24, 37]
winery3.wine_style_ids = [1, 2, 4, 5, 6]
winery3.award_ids = [24, 23]
winery3.experience_ids = []
winery3.dining_ids = []